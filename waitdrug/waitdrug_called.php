...
<table  class="table table-bordered"   id="custom2" style="background-color:green;">
  <tr>
      <td colspan="2"  style="padding: 7px;text-align: center;font-size: 60px;background-color:yellow;color:black;">รับยา</td>
    </tr>
    <?php
  ...
  ?>
        <tr>
            <td><?=$result2["depq"];?></td>
            <td>ช่องที่ <?=$result2["stationno"]?></td>
